...
const themeToggleButton = document.getElementById("themeTogle");
...
const requestApiResponse = async (incomingMessageElement) => {
    ...
    try {
        ...
        if (!responseText) throw new Error("Parece que la API se ha ido de fiesta y no ha vuelto todavía. ¡Inténtelo de nuevo más tarde cuando haya recuperado la sobriedad!");
...
clearChatButton.addEventListener('click', () => {
    if (confirm("¿Estás seguro de que deseas eliminar todo el historial de chat?")) {
